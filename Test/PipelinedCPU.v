module PipelinedCPU(SysCLK, RST, SysRST);
	...
	***********************************************************/
	...
	assign R2RS = ExCntrl[7] ? Execute[4:0] : Execute[20:16];
	assign WRS = Writeback[4:0];
	assign WD = WbCntrl[6] ? SystemBus : Outhold;
	...
	***********************************************************/
	...
	wire [6:0] NextPC;
	wire [15:0] PCsum;
	alu ADD ({9'b0, ProgramCounter}, 16'h0001, 3'b001, PCsum, );
